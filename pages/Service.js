                ...
                <Grid container spacing={6} >
                    <Grid item xs={12} md={4} lg={4} >
                        <Paper sx={{ border: 0, boxShadow: 0 }}>
                            ...
                            <Typography variant="body1" style={{ paddingTop: 20, lineHeight: 1.6 }}>We are providing a certificate to you after completing your course and this will help you future.We are providing a certificate to you after completing your course and this will help you future.
                            </Typography>
