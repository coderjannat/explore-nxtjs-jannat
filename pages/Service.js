                ...
                <Grid container spacing={6} >
                    <Grid item xs={12} md={4} lg={4} >
                        <Paper sx={{ border: 0, boxShadow: 0 }}>
                            ...
                            <Typography variant="h5" component="h5" textAlign='center' style={{ fontWeight: 700 }} >
                                Get Certificate
                            </Typography>
                            <Typography variant="body1" textAlign='center' style={{ paddingTop: 20, lineHeight: 1.6 }}>We are providing a certificate to you after completing your course and this will help <br /> you future.We are providing a certificate<br /> to you after completing your course and <br />this will help you future.
                            </Typography>
...
//                 <Grid container spacing={6} >
//                     <Grid item xs={12} md={4} lg={4} >
//                         <Paper sx={{ border: 0, boxShadow: 0, justifyContent: 'center',alignItems:'center' }}>
//                             <div className={styles.icon_bg1}>
//                                 <div className={styles.icn}>
//                                     <CardMembershipIcon sx={{ fontSize: 70, color: '#ffff' }} />
//                                 </div>
